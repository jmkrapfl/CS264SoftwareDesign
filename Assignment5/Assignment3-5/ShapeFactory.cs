...
{ 
    ...
    public shape generateDefault(string type)
    {
        ...
        switch(type)
        {
            case "rect"://handles rectangle
                ...
                if(YNCustomStyles == "y")
                {
                    newShape  = new rectangle(5,8,5,5,styles.customStyles());
                }
                else
                {
                    newShape = new rectangle(5,8,5,5,styles.defaultStyles());//makes a new shape
                }
                return newShape;
            case "circ"://handles circle
                if(YNCustomStyles == "y")
                {
                    newShape  = new circle(3,9,9,styles.customStyles());
                }
                else
                {
                    newShape = new circle(3,9,9,styles.defaultStyles());//makes a new shape
                }
                return newShape;
            case "ellipse"://handles ellipse
                if(YNCustomStyles == "y")
                {
                    newShape  = new ellipse(5,10,20,30,styles.customStyles());
                }
                else
                {
                    newShape = new ellipse(5,10,20,30,styles.defaultStyles());//makes a new shape
                }
                return newShape;
            case "line"://handles line
                if(YNCustomStyles == "y")
                {
                    newShape  = new line(5,5,20,20,styles.customStyles());
                }
                else
                {
                    newShape = new line(5,5,20,20,styles.defaultStyles());//makes a new shape
                }
                return newShape;
            case "pl"://handles polyline
                ...
                if(YNCustomStyles == "y")
                {
                    newShape  = new polyline(points,styles.customStyles());
                }
                else
                {
                    newShape = new polyline(points,styles.defaultStyles());//makes a new shape
                }
                return newShape;
            case "pg"://handles polygon
                ...
                if(YNCustomStyles == "y")
                {
                    newShape  = new polygon(points,styles.customStyles());
                }
                else
                {
                    newShape = new polygon(points,styles.defaultStyles());//makes a new shape
                }
                return newShape;
            case "path"://handles path
                ...
                if(YNCustomStyles == "y")
                {
                    newShape  = new path(points,styles.customStyles());
                }
                else
                {
                    newShape = new path(points,styles.defaultStyles());//makes a new shape
                }
                return newShape;
    ...
    public shape generateCustomShape(string type)
    {
