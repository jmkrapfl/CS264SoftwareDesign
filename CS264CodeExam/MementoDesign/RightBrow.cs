public class RightBrow:Emoji
{
    ...
    public char style { get; set;}
     //public RightBrow(int xCoord,int yCoord,int rotate, char style)
     public RightBrow(char style)
    {
        //this.xCoord=xCoord;
        //this.yCoord=yCoord;
        //this.rotate=rotate;
